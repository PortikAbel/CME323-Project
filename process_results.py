...
def write_tables(graph_type, results):
...
def main(graph_type):
  ...
  write_tables(graph_type, [result_map, result_imap_unordered, result_proc_lim])

  boxplot_result(result_map)
  boxplot_result(result_imap_unordered)
  boxplot_result(result_proc_lim)
